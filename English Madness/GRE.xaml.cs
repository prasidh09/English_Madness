...
namespace English_Madness
{
    ...
    /// </summary>
    public sealed partial class GRE : English_Madness.Common.LayoutAwarePage
    {
        public GRE()
        {
        ...
        void dtm_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            string textTitle = "GRE Preparation Data Shared From English Madness.";
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (flag == 0)
            {
                lb1.Items.Clear();
                lb2.Items.Clear();
                XmlReader obj = XmlReader.Create("DataStore/gre.xml");
                string abc = "", abc2 = "";
                while (obj.Read())
                {
                    try
                    {
                        ...
                        if (obj.NodeType == XmlNodeType.Element && obj.Name == "word")
                        {
        ...
        private void lb1_SelectionChanged(object sender, Windows.UI.Xaml.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                if (obj.NodeType == XmlNodeType.Element && obj.Name == "word")
                    if (lb1.SelectedItem.ToString() == obj.ReadInnerXml())
                    {
                        obj.ReadToNextSibling("meaning");
                        exp.Text = obj.ReadInnerXml();
                    }
            }
        ...
        private void lb2_SelectionChanged(object sender, Windows.UI.Xaml.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                if (obj.NodeType == XmlNodeType.Element && obj.Name == "word")
                    if (lb2.SelectedItem.ToString() == obj.ReadInnerXml())
                    {
                        obj.ReadToNextSibling("meaning");
                        exp1.Text = obj.ReadInnerXml();
                    }
            }
