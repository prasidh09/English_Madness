...
namespace English_Madness
{
    ...
    /// </summary>
    public sealed partial class Palindrome : English_Madness.Common.LayoutAwarePage
    {
        public Palindrome()
        {
        ...
        void dtm_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            string textTitle = "Palindrome Shared From English Madness.";
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (flag == 0)
            {
                lb1.Items.Clear();
                lb2.Items.Clear();
                XmlReader obj = XmlReader.Create("DataStore/palindrome.xml");
                string abc = "", abc2 = "";
                while (obj.Read())
                {
                    try
