...
namespace English_Madness
{
    ...
    /// </summary>
    public sealed partial class Quotes : English_Madness.Common.LayoutAwarePage
    {
        public Quotes()
        {
        ...
        void dtm_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            string textTitle = "Quote Shared From English Madness.";
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (flag == 0)
            {
                lb1.Items.Clear();
                lb2.Items.Clear();
                XmlReader obj = XmlReader.Create("DataStore/quotes.xml");
                string abc = "", abc2 = "";
                while (obj.Read())
                {
                    try
                    {
                        ...
                        if (obj.NodeType == XmlNodeType.Element && obj.Name == "quote")
                        {
            ...
            try
            {
                ...
                while (obj.Read())
                {
                    if (obj.NodeType == XmlNodeType.Element && obj.Name == "quote")
                        ...
                        {
                            obj.ReadToNextSibling("author");
                            //textblock.Text = obj.ReadInnerXml();
