...
namespace English_Madness
{
    ...
    /// </summary>
    public sealed partial class Anagrams : English_Madness.Common.LayoutAwarePage
    {
        public Anagrams()
        {
        ...
        void dtm_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            string textTitle = "Anagram Shared From English Madness.";
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (flag == 0)
            {
                lb1.Items.Clear();
                lb2.Items.Clear();
                XmlReader obj = XmlReader.Create("DataStore/anagram.xml");
                string abc = "", abc2 = "";
                while (obj.Read())
                {
                    try
